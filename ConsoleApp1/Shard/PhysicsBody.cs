...
namespace Shard
{
    internal class PhysicsBody
    {
        ...
        private List<Collider> collisionCandidates;
        ...
        private int collisionLayer = -1; // Default layer
        ...
        internal int CollisionLayer { get => collisionLayer; set => collisionLayer = value; }
        ...
        public ColliderSegment addSegmentCollider(DoomSegment segment)
        {
            ColliderSegment colliderSegment = new ColliderSegment((CollisionHandler)parent, segment);

            addCollider(colliderSegment);

            return colliderSegment;
        }
